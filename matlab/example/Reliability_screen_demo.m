...
%%%%%%%% reduced simulation range - for demonstration only
extra_load_buses_list = extra_load_buses_list(30:50);
capacity_list = [800]; % rated capacity of 1GW with typical 20% headroom
